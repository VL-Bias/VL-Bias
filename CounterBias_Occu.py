...
occupations = ["athlete", "chef", "doctor", "engineer", "farmer", "footballer", "judge", "runner", "mechanic", "nurse", "pilot", "police", "soldier"]
words = dict()
...
parser.add_argument('--data_path', default='../occu/')
...
data = json.load(open("../occu_attack_conv34.json"))
data = data["data"]
...
for verb in verbs:
    ...
    for path in data[verb]:
        ...
        bias = ((verb_b - verb_a)) / (man_b - man_a)  
        ...
        with open('../occu_vl_result.json', 'w') as json_file:
